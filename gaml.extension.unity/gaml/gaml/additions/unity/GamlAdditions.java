...
_var(gaml.extension.unity.species.AbstractUnityLinker.class,desc(5,S("type","5","name","background_geoms_is3D","of","3")),(s,a,t,v)->t==null? null:((gaml.extension.unity.species.AbstractUnityLinker)t).getBackgroundGeoms3D(a),null,(s,a,t,v)->{if (t != null) ((gaml.extension.unity.species.AbstractUnityLinker) t).setBackgroundGeoms3D(a, (IList) v); return null; });
...
_action(new GamaHelper("send_geometries",gaml.extension.unity.species.AbstractUnityLinker.class,(s,a,t,v)->{((gaml.extension.unity.species.AbstractUnityLinker) t).primSentGeometries(s);return null;}),desc(PRIM,new Children(_arg("geoms",5,T),_arg("heights",5,T),_arg("players",5,T),_arg("geometry_colliders",5,T),_arg("is_3D",5,T),_arg("names",5,T),_arg("tags",5,T)),NAME,"send_geometries",TYPE,Ti(void.class),VIRTUAL,FALSE),gaml.extension.unity.species.AbstractUnityLinker.class.getMethod("primSentGeometries",SC));
