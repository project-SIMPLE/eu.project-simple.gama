...
_action(new GamaHelper("add_background_geometries",gaml.extension.unity.species.AbstractUnityLinker.class,(s,a,t,v)->{((gaml.extension.unity.species.AbstractUnityLinker) t).primAddBackgroundGeometries(s);return null;}),desc(PRIM,new Children(_arg("geometries",16,T),_arg("property",28463575,T)),NAME,"add_background_geometries",TYPE,Ti(void.class),VIRTUAL,FALSE),gaml.extension.unity.species.AbstractUnityLinker.class.getMethod("primAddBackgroundGeometries",SC));
...
_action(new GamaHelper("add_geometries_to_send",gaml.extension.unity.species.AbstractUnityLinker.class,(s,a,t,v)->{((gaml.extension.unity.species.AbstractUnityLinker) t).primAddGeometriesToSend(s);return null;}),desc(PRIM,new Children(_arg("geometries",16,T),_arg("property",28463575,T)),NAME,"add_geometries_to_send",TYPE,Ti(void.class),VIRTUAL,FALSE),gaml.extension.unity.species.AbstractUnityLinker.class.getMethod("primAddGeometriesToSend",SC));
...
_action(new GamaHelper("move_geoms_followed",gaml.extension.unity.species.AbstractUnityLinker.class,(s,a,t,v)->{((gaml.extension.unity.species.AbstractUnityLinker) t).primMoveGeomsFollowed(s);return null;}),desc(PRIM,new Children(_arg("ids",4,T),_arg("points",4,T),_arg("sep",4,T)),NAME,"move_geoms_followed",TYPE,Ti(void.class),VIRTUAL,FALSE),gaml.extension.unity.species.AbstractUnityLinker.class.getMethod("primMoveGeomsFollowed",SC));
