...
_type("unity_aspect",new gaml.extension.unity.types.UnityAspectType(),352633,104,gaml.extension.unity.types.UnityAspectType.class);
_type("unity_property",new gaml.extension.unity.types.UnityPropertiesType(),28463575,104,gaml.extension.unity.types.UnityPropertiesType.class);
...
_field(gaml.extension.unity.types.UnityProperties.class,"collider",null,3,gaml.extension.unity.types.UnityProperties.class,3,0,0);
_field(gaml.extension.unity.types.UnityProperties.class,"interactable",null,3,gaml.extension.unity.types.UnityProperties.class,3,0,0);
_field(gaml.extension.unity.types.UnityProperties.class,"grabable",null,3,gaml.extension.unity.types.UnityProperties.class,3,0,0);
...
_operator(S("geometry_properties"),gaml.extension.unity.operators.Operators.class.getMethod("newUnityGeometrytoSend",S,gaml.extension.unity.types.UnityAspect.class,S,b,b,b),null,AI,gaml.extension.unity.types.UnityProperties.class,T,-13,-13,-13,-13,(s,o)->gaml.extension.unity.operators.Operators.newUnityGeometrytoSend(((String)o[0]),((gaml.extension.unity.types.UnityAspect)o[1]),((String)o[2]),asBool(s,o[3]),asBool(s,o[4]),asBool(s,o[5])),F);
